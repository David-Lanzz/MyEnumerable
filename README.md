...
- Function to return boolean values depending on state of arguments and conditions.
...
```sh
  cd my-folder
  git clone https://github.com/David-Lanzz/MyEnumerable.git
```
...
Feel free to check the [issues page](https://github.com/David-Lanzz/MyEnumerable/issues).
